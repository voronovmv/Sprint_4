...
class TestBooksCollector:
    ...
    def test_add_new_book_adds_book_with_valid_name(self, collector, name):
    ...
    def test_add_new_book_does_not_add_book_with_invalid_length(self, collector, name):
        collector.add_new_book(name)
        assert name not in collector.get_books_genre()

    # Проверяем, что одну и ту же книгу нельзя добавить дважды
    def test_add_new_book_does_not_add_same_book_twice(self, collector):
        name = "Война и мир"
        collector.add_new_book(name)
        collector.add_new_book(name)
    ...
    def test_add_new_book_sets_empty_genre_by_default(self, collector):
        name = "Война и мир"
        collector.add_new_book(name)
    ...
    def test_set_book_genre_sets_genre_for_existing_book_with_valid_genre(self, collector):
    ...
    def test_set_book_genre_does_not_set_genre_for_nonexistent_book(self, collector):
    ...
    def test_get_books_with_specific_genre_returns_only_books_of_that_genre(self, collector):
    ...
    def test_add_book_in_favorites_does_not_add_twice(self, collector):
        collector.add_new_book("Война и мир")
        collector.add_book_in_favorites("Война и мир")
        collector.add_book_in_favorites("Война и мир")
    ...
    def test_delete_book_from_favorites_removes_book_if_present(self, collector):
        collector.add_new_book("Война и мир")
        collector.add_book_in_favorites("Война и мир")
